...
# ADDITIONAL 
def classification_evaluation(prediction):
    """
    Test a classification model with accuracy, precision, recall, f1 score, and AUC.
    
    :param list prediction: list with model's predictions  
    :return: none
    """
